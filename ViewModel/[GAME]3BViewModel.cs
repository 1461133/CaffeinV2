...
namespace ViewModel
{
    public class _GAME_3BViewModel : ObservableObject
    {
        #region Constructor
        ...
        /// </summary>
        public _GAME_3BType BubbleType { get; private set; }
        ...
        static _GAME_3BType GetRandomBubbleType()
        {
            var bubbleTypeValues = Enum.GetValues(typeof(_GAME_3BType)) as _GAME_3BType[];
            int highestValue = bubbleTypeValues.Length - 1;
            return (_GAME_3BType)_random.Next(0, highestValue + 1);
        }
        ...
        readonly _3BLocationManager _locationManager;
